...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('portal-config', static function () {
        ...
        // Sub-categories: models for complaint form (before resource show ambiguity)
        Route::get('sub-categories/{subCategoryId}/equipment-models', [EquipmentModelController::class, 'forSubCategory'])
            ->whereNumber('subCategoryId')
            ->name('sub-categories.equipment-models');
